...
export const PanelSideBar = component$(() => {
  const items: { title: string; link: string; icon: JSX.Element }[] = [
    {
      title: "Dashboard",
      link: "/panel/",
      icon: (
  ...
  return (
    <div class="absolute hidden h-screen w-64 bg-gray-100 shadow lg:relative lg:block">
      <div class="flex h-16 w-full items-center px-8">
        <h1 class="text-xl font-bold">
          Mailgun <small>UI</small>
        </h1>
        {/* <svg
          xmlns="http://www.w3.org/2000/svg"
          width={144}
      ...
      <ul aria-orientation="vertical" class=" py-6">
        {items.map((item, i) => (
          <li
            key={item.title}
            class="text-white- cursor-pointer pb-4 pl-6 pt-5 text-sm leading-3 tracking-normal  focus:text-indigo-700 focus:outline-none"
          >
            <NavLink
