...
export const PanelMobileSideBar = component$(() => {
  return                             <div class="flex flex-col justify-between h-full w-full">
                                <div>
                                    <div class="flex items-center justify-between px-8">
                                        ...
                                        <div id="closeSideBar" class="flex items-center justify-center h-10 w-10" onClick$={() => show.value=!show.value}>
                                    ...
                                    <ul aria-orientation="vertical" class=" py-6">
                                        <li class="pl-6 cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5  focus:text-indigo-700 focus:outline-none">
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 xl:text-base md:text-2xl text-base">Dashboard</span>
                                            </div>
                                        </li>
                                        <li class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 xl:text-base md:text-2xl text-base">Products</span>
                                            </div>
                                        </li>
                                        <li class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 xl:text-base md:text-2xl text-base">Performance</span>
                                            </div>
                                        </li>
                                        <li class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 xl:text-base md:text-2xl text-base">Deliverables</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="w-full">
                                    <div class="flex justify-center mb-4 w-full px-6">
                                        <div class="relative w-full">
                                            ...
                                            <input class="bg-gray-200 focus:outline-none rounded w-full text-sm text-gray-500  pl-10 py-2" type="text" placeholder="Search" />
                                        </div>
                                    </div>
                                    <div class="border-t border-gray-300">
                                        <div class="w-full flex items-center justify-between px-6 pt-1">
                                            <div class="flex items-center">
                                                <img width={32} height={32} alt="profile-pic" src="https://tuk-cdn.s3.amazonaws.com/assets/components/boxed_layout/bl_1.png" class="w-8 h-8 rounded-md" />
